...
internal class ProductAttributeTranslationConfiguration : BaseAuditableEntityConfiguration<ProductAttributeTranslation>
{
    public override void Configure(EntityTypeBuilder<ProductAttributeTranslation> builder)
    {
        ...
        builder.HasIndex(x => new { x.ProductAttributeId, x.LanguageCode })
            .IsUnique()
            .HasFilter("\"Deleted\" = false");
